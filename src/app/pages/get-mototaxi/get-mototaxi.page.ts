...
@Component({
  selector: 'app-get-mototaxi',
  templateUrl: './get-mototaxi.page.html',
  styleUrls: ['./get-mototaxi.page.scss'],
  standalone: true,
  imports: [
    IonButton,
    IonNote,
...
export class GetMototaxiPage implements OnInit {
  ...
  form = this._fb.group({
    vehiculo: this._fb.control(this.taxis[1].tipo),
